...
const char * CCLocalizedString(const char * mKey,const char * mComment)
{
    ...
    switch (curLanguage) {
        case kLanguageEnglish:
            fileName = "Localizable_en";
            break;
        case kLanguageRussian:
            fileName = "Localizable_ru";
            break;
        case kLanguageFrench:
            fileName = "Localizable_fr";
            break;
        case kLanguageItalian:
            fileName = "Localizable_it";
            break;
        case kLanguageGerman:
            fileName = "Localizable_ge";
            break;
        case kLanguageSpanish:
            fileName = "Localizable_sp";
            break;
        case kLanguagePortuguese:
            fileName = "Localizable_pr";
            break;
            /**
